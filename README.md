...
- **Frontend (React - GitHub Pages)**: [https://richadas123.github.io/Editor/]
- **Backend (Express API)**: [https://editor-vrh3.onrender.com]
- **Frontend**: [https://editor-1-ehgx.onrender.com]
...
- Monaco Editor 
- Supports multiple languages via Judge0 (C, C++, JavaScript, Python)
...
Judge0 API Usage:-
The proxy server sends code submissions to the public Judge0 API.
Returns execution results which are displayed in the output console.
